...
oauthModule.submodule('stripe')
  ...
  .configurable({
    scope: "A space seperated list of scope values of Stripe scopes to be accessed.  See the documentation to determine what scope you'd like to specify.  If not specified, it will default to: api refresh_token"
  })
